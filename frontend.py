...
#def store_value(secret_key):
    #st.session_state[secret_key] = st.session_state["input_OPENAI_API_KEY"]
...
def run():
    ...
    try:
        ...
        with st.sidebar:
            st.markdown("Remembering your API key for this session. Refreshing this tab will forget this key")
    except:
        openai_api_key = ""
    ...
    with st.sidebar:
       st.text("Powered by Streamlit and LangChain")
